...
namespace ut {
    ...
    namespace str {
        ...
        QVariantList replaceTag(QString txt,int fromIndex,QString srcTag1,QString srcTag2,
                                QString dstTag1,QString dstTag2,int mode, QString param,
...
//                      qDebug() << param << paramTemplate << dstTag1 << dstTag2;
        ...
        QString replaceAllTag(QString txt,QString srcTag1,QString srcTag2,QString dstTag1,QString dstTag2,int mode, QString param,
                              QVariantList (*cb)(QString srcTag1, QString srcTag2, QString dstTag1, QString dstTag2, QString k, QString param)) {
            int from = 0;
            while(true) {
                ...
                QVariantList m = replaceTag(txt,from, srcTag1,srcTag2,dstTag1,dstTag2,mode,param,cb);
                txt = m[0].toString();
                from = m[1].toInt();
            }
            return txt;
